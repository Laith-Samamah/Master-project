...
(function ($) {
    ...
    $("ul.drawer-tabs li").on("click", function () {
        ...
        $(".tab-drawer-heading[data-tab^='" + activeTab + "']").addClass(
            "d_active"
        );
    ...
    $(".tab-drawer-heading").on("click", function () {
        ...
        $("ul.drawer-tabs li").removeClass("active");
        $("ul.drawer-tabs li[data-tab^='" + d_activeTab + "']").addClass(
            "active"
        );
    ...
    $("[data-countdown]").each(function () {
        ...
        $this.countdown(finalDate, function (event) {
            $this.html(
                event.strftime(
                    '<ul class="counter timer clearfix"><li class="ht-count days"><span id="day" class="digit days">%-D</span> <span class="smalltext">Days</span></li> <li class="ht-count hour"><span id="hour" class="digit hours">%-H</span> <span class="smalltext">Hrs</span></li> <li class="ht-count minutes"><span id="minute" class="digit minutes">%M</span> <span class="smalltext">Min</span></li> <li class="ht-count second"><span id="second" class="digit seconds">%S</span> <span class="smalltext">Sec</span></li></ul>'
                )
            );
        });
    });
     ...
     * 19. Product Filter Dropdown
     * ========================================================================== */
    $(".filter-block .block-title,.cms-block .sub-title").on(
        "click",
        function () {
            if ($(window).width() < 991) {
            ...
            $(
                ".filter-block .block-content,.cms-block .cms-block-content"
    ...
    if ($("#pro-details-sticky").length) {
        var top =
            $("#pro-details-sticky").offset().top -
            parseFloat(
                $("#pro-details-sticky").css("marginTop").replace(/auto/, 0)
            );
    }
    if ($("#products-detail-tabs").length) {
        var footTop =
            $("#products-detail-tabs").offset().top -
            parseFloat(
                $("#products-detail-tabs").css("marginTop").replace(/auto/, 0)
            );
    }
