                    ...
                    <div class="container">
                        <div class="row no-gutters">
                            ...
                            <div class="col-12 col-sm-12 col-md-12 col-lg-9 newsletter-menulinks">
                                ...
                                <div class="row no-gutters footer-links d-flex justify-content-around">
                                    ...
                                    <div class="col-12 col-sm-12 col-md-3 col-lg-3 contact">
                                        ...
                                        <ul class="linklist contact-info d-flex flex-column">
                                            <li><i class="icon ti-location-pin"></i><span>New Zarqa - Al Karamah st. <br/>Zarqa, Jordan</span></li>
                                            <li><i class="icon fa fa-phone"></i><a href="tel:+962778082198">(+962) 778082198</a></li>
                                            <li><i class="icon ti-email"></i><a href="info@sparkparts.com">info@sparkparts.com</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="footer-bottom clearfix">
                    <div class="container">
                        <div class="copyright-content pt-md-1 pull-left"> 
                            <span class="content"> Copyright &copy; 2022 Spark Parts. All Rights Reserved.</span> 
                        </div>
                    </div>
                </div>
            </footer>
                    ...
                    <div class="minicart-details">
                        ...
                        <ul class="cart-lists clearfix">
                            <li class="cart-item d-table">
                                <div class="pro-img d-table-cell align-middle">
                                    <a href="product-details.html">
                                        <img class="img-fluid blur-up lazyload" src="images/products/cart-pro-76x76.jpg" data-src="images/products/cart-pro-76x76.jpg" alt="image" title="Donec pede justo fringilla" />
                                    </a>
                                </div>
                            ...
                            <li class="cart-item d-table">
                                <div class="pro-img d-table-cell align-middle">
                                    <a href="product-details.html">
                                        <img class="img-fluid blur-up lazyload" src="images/products/cart-pro-76x76.jpg" data-src="images/products/cart-pro-76x76.jpg" alt="image" title="Sociosqu facilisi senectus nisi etiam" />
                                    </a>
                                </div>
                            ...
                            <li class="cart-item d-table">
                                <div class="pro-img d-table-cell align-middle">
                                    <a href="product-details.html">
                                        <img class="img-fluid blur-up lazyload" src="images/products/cart-pro-76x76.jpg" data-src="images/products/cart-pro-76x76.jpg" alt="image" title="Nullam scelerisque suscipit sociis" />
                                    </a>
                                </div>
                                <div class="item-info pl-4 text-left d-table-cell align-top">
                            ...
                            <li class="cart-item d-table">
                                <div class="pro-img d-table-cell align-middle">
                                    <a href="product-details.html">
                                        <img class="img-fluid blur-up lazyload" src="images/products/cart-pro-76x76.jpg" data-src="images/products/cart-pro-76x76.jpg" alt="image" title="Pellentesque habitant morbi" />
                                    </a>
                                </div>
                                <div class="item-info pl-4 text-left d-table-cell align-top">
            ...
            <div id="open-addtocart-popup" class="addtocart-popup magnific-popup mfp-hide">
                <div class="addtocart-inner-content text-center">
                    ...
                    <p class="pro-img"><img class="img-fluid blur-up lazyload" src="images/products/addtocart-popup.jpg" data-src="images/products/addtocart-popup.jpg" alt="image" title="image" /></p>
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-6">
                            <div class="product-single-photo slider thumbnails-single">
                                <div class="single-item"><img class="img-fluid blur-up lazyload" src="images/products/quick-view-1.jpg" data-src="images/products/quick-view-1.jpg" alt="image" title="image" /></div>
                                <div class="single-item"><img class="img-fluid blur-up lazyload" src="images/products/quick-view-1.jpg" data-src="images/products/quick-view-1.jpg" alt="image" title="image" /></div>
                                <div class="single-item"><img class="img-fluid blur-up lazyload" src="images/products/quick-view-1.jpg" data-src="images/products/quick-view-1.jpg" alt="image" title="image" /></div>
                                <div class="single-item"><img class="img-fluid blur-up lazyload" src="images/products/quick-view-1.jpg" data-src="images/products/quick-view-1.jpg" alt="image" title="image" /></div>
                                <div class="single-item"><img class="img-fluid blur-up lazyload" src="images/products/quick-view-1.jpg" data-src="images/products/quick-view-1.jpg" alt="image" title="image" /></div>
                            ...
                            <div class="product-thumb slider thumbnail-items">
                                <div class="thumb-item"><img class="img-fluid blur-up lazyload" src="images/products/quick-view-1-item.jpg" data-src="images/products/quick-view-1-item.jpg" alt="image" title="image" /></div>
                                <div class="thumb-item"><img class="img-fluid blur-up lazyload" src="images/products/quick-view-1-item.jpg" data-src="images/products/quick-view-1-item.jpg" alt="image" title="image" /></div>
                                <div class="thumb-item"><img class="img-fluid blur-up lazyload" src="images/products/quick-view-1-item.jpg" data-src="images/products/quick-view-1-item.jpg" alt="image" title="image" /></div>
                                <div class="thumb-item"><img class="img-fluid blur-up lazyload" src="images/products/quick-view-1-item.jpg" data-src="images/products/quick-view-1-item.jpg" alt="image" title="image" /></div>
                                <div class="thumb-item"><img class="img-fluid blur-up lazyload" src="images/products/quick-view-1-item.jpg" data-src="images/products/quick-view-1-item.jpg" alt="image" title="image" /></div>
            ...
            <div id="open-wishlist-popup" class="wishlist-popup magnific-popup mfp-hide">
                <div class="wishlist-inner-content text-center">
                    ...
                    <p class="pro-img"><img class="img-fluid blur-up lazyload" src="images/products/addwishlist-popup.jpg" data-src="images/products/addwishlist-popup.jpg" alt="image" title="image" /></p>
